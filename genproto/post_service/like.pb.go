...
func (x *GetLikeRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
type GetAllLikesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetAllLikesRequest) Reset() {
	*x = GetAllLikesRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetAllLikesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAllLikesRequest) ProtoMessage() {}

func (x *GetAllLikesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_like_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAllLikesRequest.ProtoReflect.Descriptor instead.
func (*GetAllLikesRequest) Descriptor() ([]byte, []int) {
	return file_like_proto_rawDescGZIP(), []int{2}
}

func (x *GetAllLikesRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *GetAllLikesRequest) GetPage() int32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *GetAllLikesRequest) GetSearch() string {
	if x != nil {
		return x.Search
	}
	return ""
...
func (x *GetAllLikesResponse) Reset() {
	*x = GetAllLikesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetAllLikesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAllLikesResponse) ProtoMessage() {}

func (x *GetAllLikesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_like_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAllLikesResponse.ProtoReflect.Descriptor instead.
func (*GetAllLikesResponse) Descriptor() ([]byte, []int) {
	return file_like_proto_rawDescGZIP(), []int{3}
}

func (x *GetAllLikesResponse) GetLikes() []*Like {
	if x != nil {
		return x.Likes
	}
	return nil
...
func (x *GetAllLikesResponse) GetCount() int32 {
	if x != nil {
		return x.Count
	}
	return 0
...
var file_like_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x20, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x4c,
	...
	0x74, 0x41, 0x6c, 0x6c, 0x4c, 0x69, 0x6b, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x63, 0x68, 0x22, 0x51, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x4c, 0x69, 0x6b, 0x65,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x24, 0x0a, 0x05, 0x6c, 0x69, 0x6b,
	0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x67, 0x65, 0x6e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2e, 0x4c, 0x69, 0x6b, 0x65, 0x52, 0x05, 0x6c, 0x69, 0x6b, 0x65, 0x73, 0x12,
...
var file_like_proto_goTypes = []interface{}{
	...
	(*GetAllLikesRequest)(nil),  // 2: genproto.GetAllLikesRequest
	(*GetAllLikesResponse)(nil), // 3: genproto.GetAllLikesResponse
}
var file_like_proto_depIdxs = []int32{
	0, // 0: genproto.GetAllLikesResponse.likes:type_name -> genproto.Like
...
func file_like_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_like_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAllLikesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_like_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAllLikesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
